...
<body>
    ...
    <div class="row flex-lg-row-reverse align-items-center g-5 m-4"> 
        <div class="col-10 col-sm-8 col-lg-6"> 
            <img src="img/cfaadd5bcd10b95630608b907e6de279 (1).jpg" class="d-block mx-lg-auto img-fluid rounded-4" alt="Bootstrap Themes" width="700" height="500" loading="lazy "> 
        </div> 
        <div class="col-lg-6"> 
